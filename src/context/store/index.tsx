import { IStore, IStoreContext, IStoreProviderProps, IStoreState } from '@context/store/interface';
...
function initializeStore(snapshot?: IStoreState): IStoreContext {
	...
	// get hydrated here, check `pages/ssg.tsx` and `pages/index.ssr.tsx` for more details
	if (snapshot) {
		applySnapshot(_store, snapshot);
	}
	// For SSG and IndexSsr always create a new store
