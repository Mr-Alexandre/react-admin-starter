...
export interface IHttpClient {
	...
	post<T, R>(url: string, data?: unknown, config?: THttpClientRequestConfig): Promise<R>

	put<T, R>(url: string, data?: unknown, config?: THttpClientRequestConfig): Promise<R>

	patch<T, R>(url: string, data?: unknown, config?: THttpClientRequestConfig): Promise<R>
	...
	addInterceptor(interceptor: THttpClientInterceptor): THttpClientInterceptorIds
